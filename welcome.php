...
<!-- 
    <div class="container vertical-center">
        <h1 class="my-5 text-white">Hi, <b></b>. Welcome to our site.</h1>
        <div class="mb-3">
            <a href="reset-password.php" class="btn btn-warning">Reset Your Password</a>
            <a href="logout.php" class="btn btn-danger ml-3">Sign Out of Your Account</a>
    ...
    <div class="container vertical-center">
    <h1 class="my-5 text-white text-center">HI, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. WELCOME TO P. A. INAMDAR IAS COACHING INSTITUTE, PUNE.
</h1>
    <div class="mb-3">
        <a href="reset-password.php" class="btn btn-warning mb-2 btn-lg mb-md-0">Reset Your Password</a>
        <!-- <a href="http://acapp.co.in/payment" class="btn btn-success ml-md-3 mb-2 mb-md-0">Payments</a> -->
        <a href="application.php" class="btn btn-primary ml-md-3 btn-lg ">Application Form</a>
        <a href="logout.php" class="btn btn-danger ml-md-3 mb-2 btn-lg mb-md-0">Sign Out of Your Account</a>
    </div>
</div>
